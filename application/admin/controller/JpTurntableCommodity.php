...
use app\admin\model\JpTurntableCommodity AS MJpTurntableCommodity;
use think\Request;

class JpTurntableCommodity extends ApiCommon
{
    ...
    {   
        $query = new MJpTurntableCommodity();
    ...
    {
        $res = MJpTurntableCommodity::get($id)->delete();
        if ($res) {
    ...
    {   
        $TurntableCommodity = MJpTurntableCommodity::get($id);
        ...
        $TurntableCommodity->currency_num = $request->post('currency_num');
        $TurntableCommodity->type = $request->post('type');
    ...
    public function Post(Request $request)
    {
        $data = [
            ...
            'currency_num'=>$request->post('currency_num'),
            'type'=>$request->post('type')
        ];
        $JpTurntableCommodity = MJpTurntableCommodity::create($data);

        if ($JpTurntableCommodity) {
