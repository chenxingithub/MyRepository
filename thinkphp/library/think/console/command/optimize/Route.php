...
class Route extends Command
{
    ...
    {
        file_put_contents(RUNTIME_PATH . 'route.tmp.php', $this->buildRouteCache());
        rename(RUNTIME_PATH . 'route.tmp.php', RUNTIME_PATH . 'route.php');
        chmod(RUNTIME_PATH . 'route.php', 0644);
