...
EOF;
        ...
        file_put_contents(RUNTIME_PATH . 'classmap.tmp' . EXT, $classmapFile);
        rename(RUNTIME_PATH . 'classmap.tmp' . EXT, RUNTIME_PATH . 'classmap' . EXT);
        chmod(RUNTIME_PATH . 'classmap' . EXT, 0644);
