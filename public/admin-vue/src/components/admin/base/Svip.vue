                            ...
                            <div class="row">
                                <div class="col-md-3">
                            	 <!-- @keyup.enter.native="handleFilter"  监听回车事件执行handleFilter方法 -->
                                    <el-input style="width: 50%;" @keyup.enter.native="handleFilter" class="filter-item" placeholder="标题" v-model="listQuery.keyword">
                                    </el-input>
                                </div>
                                <div class="col-md-3">
                                    位置：
                            ...
                            <table class="table table-hover">
                                <tbody>
                                    <tr>
                                        ...
                                        <th style="word-break: break-word;">认证金额</th>
                                        <th>客服QQ</th>
                                        <th>状态</th>
                                        <th>操作</th>
                                        <th>SVIP礼包ICON</th>
                                    ...
                                    <tr v-for="item in items">
                                        ...
                                        <td>{{ item['trigger_amount'] }}</td>
                                        <td>{{ item['customer_service_qq']}}</td>
                                        <td>
                                            <el-tag :type="item['status'] | statusFilter">{{ item['status'] | statusShow }}</el-tag>
                                        </td>
                                        <td>
                                            <el-button  size="small" @click="handleModifyStatus(item,1)">修改
                                            </el-button>
                                            <el-button size="small" type="danger" icon="delete" @click="handleDelete(item)">删除</el-button>
                                        </td>
                                        <td><span class="link-type" @click="handleUpdate(item)"><img :src="ImgPrefix+item['svip_icon_1']" style="width: 46px; height: 46px;" class="media-object img-circle"></span></td>
                                        <td><span class="link-type" @click="handleUpdate(item)"><img :src="ImgPrefix+item['svip_icon_2']" style="width: 46px; height: 46px;" class="media-object img-circle"></span></td>
                                        <td><span class="link-type" @click="handleUpdate(item)"><img :src="ImgPrefix+item['svip_icon_3']" style="width: 46px; height: 46px;" class="media-object img-circle"></span></td>
                                        <td><span class="link-type" @click="handleUpdate(item)"><img :src="ImgPrefix+item['svip_icon_4']" style="width: 46px; height: 46px;" class="media-object img-circle"></span></td>
                                        <td><span class="link-type" @click="handleUpdate(item)"><img :src="ImgPrefix+item['svip_icon_5']" style="width: 46px; height: 46px;" class="media-object img-circle"></span></td>
                                        <td><span class="link-type" @click="handleUpdate(item)"><img :src="ImgPrefix+item['authentication_icon_1']" style="width: 46px; height: 46px;" class="media-object img-circle"></span></td>
                                        <td><span class="link-type" @click="handleUpdate(item)"><img :src="ImgPrefix+item['authentication_icon_2']" style="width: 46px; height: 46px;" class="media-object img-circle"></span></td>
                                        <td><span class="link-type" @click="handleUpdate(item)"><img :src="ImgPrefix+item['authentication_icon_3']" style="width: 46px; height: 46px;" class="media-object img-circle"></span></td>
                                        <td><span class="link-type" @click="handleUpdate(item)"><img :src="ImgPrefix+item['authentication_icon_4']" style="width: 46px; height: 46px;" class="media-object img-circle"></span></td>
                                        <td><span class="link-type" @click="handleUpdate(item)"><img :src="ImgPrefix+item['authentication_icon_5']" style="width: 46px; height: 46px;" class="media-object img-circle"></span></td>
                        ...
                        <el-form class="small-space" :model="temp" :rules="rules" ref="temp"  label-position="left" label-width="100px" style='width: 800px; margin-left:100px;'>
                            <el-form-item label="图标">
                                <el-upload
                                    ...
                                    <img v-if="temp.picture" :src="ImgPrefix+temp.picture" class="avatar" style="width:100px;height:100px;">
                                    <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                                </el-upload>
                            </el-form-item>
                        
                            <el-form-item label="渠道" prop="channel_id">
                                <el-input style="width: 50%;" v-if="dialogStatus=='update'" v-model="temp.channel_id"></el-input>
                                <el-input style="width: 50%;" v-else v-model="temp.channel_id"></el-input>
                            </el-form-item>
...
/*                this.$notify({
            ...
            handleCreate(){
                ...
                this.temp.id = 1
                this.temp.channel_id = 0
               this.temp.customer_service_qq = ''
                this.temp.trigger_amount= ''
                this.temp.status = 1
                this.temp.svip_icon_1
                this.temp.svip_icon_2 = ''
                this.temp.svip_icon_3 = ''
                this.temp.svip_icon_4 = ''
                this.temp.svip_icon_5 = ''
                this.temp.svip_icon_1 = ''
                this.temp.svip_icon_2 = ''
                this.temp.svip_icon_3 = ''
                this.temp.svip_icon_4 = ''
            ...
            handleUpdate(data) {
                ...
                this.temp.channel_id = data.channel_id
                this.temp.customer_service_qq = data.customer_service_qq
                this.temp.trigger_amount= data.trigger_amount
                this.temp.status = data.status
                this.temp.svip_icon_1 = data.svip_icon_1
                this.temp.svip_icon_2 = data.svip_icon_2
                this.temp.svip_icon_3 = data.svip_icon_3
                this.temp.svip_icon_4 = data.svip_icon_4
                this.temp.svip_icon_5 = data.svip_icon_5
                this.temp.svip_icon_1 = data.svip_icon_1
                this.temp.svip_icon_2 = data.svip_icon_2
                this.temp.svip_icon_3 = data.svip_icon_3
                this.temp.svip_icon_4 = data.svip_icon_4
...
/*                this.$axios.get('/admin/user/' + data.id)
            ...
            update(formName){
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$axios.put('/focus/put/' + this.temp.id, {
