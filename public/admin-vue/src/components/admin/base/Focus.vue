                            ...
                            <table class="table table-hover">
                                <tbody>
                                    <tr>
                                        ...
                                        <th style="word-break: break-word;">标题</th>
                                        <th>跳转链接</th>
                                        <th>位置</th>
                                        <th>终端</th>
                                        <th>创建时间</th>
                                    ...
                                    <tr v-for="item in items">
                                        <td>{{ item['id'] }}</td>
                                        <td><span class="link-type" @click="handleUpdate(item)"><img :src="ImgPrefix+item['picture']" style="width: 46px; height: 46px;" class="media-object img-circle"></span></td>
                                        <td >{{ item['title'] }}</td>
                                        <td >{{ item['jump_url'] }}</td>
                                         <td >{{ item['position'] | positionShow }}</td>
                        ...
                        <el-form class="small-space" :model="temp" :rules="rules" ref="temp"  label-position="left" label-width="100px" style='width: 800px; margin-left:100px;'>
                            <el-form-item label="焦点图">
                                <el-upload
                                    ...
                                    <img v-if="temp.picture" :src="ImgPrefix+temp.picture" class="avatar" style="width:80px;height:80px;">
