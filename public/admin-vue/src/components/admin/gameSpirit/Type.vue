            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible"  size="small">
                        <el-form class="small-space" :model="temp" :rules="rules" ref="temp"  label-position="left" label-width="100px" style='margin-left:100px;'>
...
/*                this.$notify({
            ...
            handleDelete(data) {
                this.$confirm('此操作将永久删除该焦点图, 是否继续?', '提示', {
                    ...
                    this.$axios.delete('/spirit-type/' + data.id)
                        .then((response) => {
            ...
            update(formName){
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$axios.put('/spirit-type/' + this.temp.id, {
                            name: this.temp.name,
