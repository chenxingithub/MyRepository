                          ...
                          <el-table
                            ...
                            <el-table-column
                              ...
                              <template slot-scope="scope">
                                <el-switch
                                  ...
                                  :active-value="1"
                                  :inactive-value="0"
                                  @change="retrievalSignUpdate(scope.row)"
                                  >
                                </el-switch>
                              </template>
                            </el-table-column>
                            ...
                            <el-table-column
                              ...
                              <template slot-scope="scope">
                                <el-button
                                  size="mini"
                                  @click="handleUpdate(scope.row)" icon="el-icon-edit">详情</el-button>
                                <el-button
                                  size="mini"
                                  type="danger"
                   ...
                   <!-- /.box-body -->
                    ...
                    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible"  size="small">
                              ...
                              <el-row style="margin-bottom: 1rem;">
                                  <el-col :span="24"><span>最近20条检索记录</span></el-col>
                              </el-row>
                              ...
                              <el-row>
                                  <el-col :span="23" :offset="1" v-html="dialoguevalue.retrieval_message"></el-col>
                              </el-row>
                              </el-card>
...
/*                this.$notify({
            ...
            handleUpdate(data) {
                ...
                this.Reply = '';
                this.$axios.get('/spirit/retrieval-dialogue', {
                  headers: this.$store.state.headers,
                  params: {
                              game_id: this.$route.params.id,
            ...
            handleDelete(data) {
                this.$confirm('此操作将永久删除改规则, 是否继续?', '提示', {
                    ...
                    this.$axios.delete('/spirit/retrieval/' + data.id)
                        .then((response) => {
                            if(response.status === 200){
                                this.$message({
                                    showClose: true,
